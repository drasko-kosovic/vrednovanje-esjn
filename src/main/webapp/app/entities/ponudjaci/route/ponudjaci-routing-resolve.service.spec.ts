...
describe('Service Tests', () => {
  describe('Ponudjaci routing resolve service', () => {
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(PonudjaciRoutingResolveService);
      service = TestBed.inject(PonudjaciService);
      resultPonudjaci = undefined;
    });

    describe('resolve', () => {
      it('should return IPonudjaci returned by find', () => {
        // GIVEN
      ...
      it('should route to 404 page if data not found in server', () => {
        ...
        // THEN
        expect(service.find).toBeCalledWith(123);
        expect(resultPonudjaci).toEqual(undefined);
